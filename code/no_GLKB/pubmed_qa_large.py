...
parser = argparse.ArgumentParser(description="The testing code for PubMedQA large (1500 questions) with no GLKB or external resources.")
...
OUTPUT_PATH = f'./outputs/pubmedqa_large_{llm}_{time.time()}.json'
